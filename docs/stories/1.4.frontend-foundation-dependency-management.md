...
- [ ] Task 1: Initialize Next.js Project with TypeScript (AC: 1, 5)
  - [ ] Create Next.js application with App Router in apps/web/
  - [ ] Configure TypeScript 5.1.6+ with strict mode enabled (Epic 1 canonical)
  - [ ] Setup next.config.js with optimizations and environment variables
  - [ ] Create .env.example with NEXT_PUBLIC_API_URL=http://localhost:8001/api/v1
  - [ ] Verify Next.js development server starts successfully

- [ ] Task 2: Create Frontend Project Structure (AC: 1)
  - [ ] Setup App Router directory structure (app/, components/, lib/)
  - [ ] Create layout components (root layout, dashboard layout)
  - [ ] Setup middleware for route protection
  - [ ] Configure public/ directory for static assets
  - [ ] Create utility directories (hooks/, store/, services/, types/, **tests**/)

- [ ] Task 3: Configure Tailwind CSS and shadcn/ui (AC: 2, 5)
  - [ ] Install and configure Tailwind CSS 3.3.0+ with Next.js
  - [ ] Setup shadcn/ui CLI and initialize component library
  - [ ] Configure tailwind.config.js with shadcn/ui theme settings
  - [ ] Install Radix UI primitives and Lucide React icons
  - [ ] Verify shadcn/ui installation with test component

- [ ] Task 4: Setup State Management Dependencies (AC: 3, 5)
  - [ ] Install React Query 5.x for server state management
  - [ ] Install Zustand 4.x for client state management
  - [ ] Configure React Query provider with default options
  - [ ] Create initial Zustand stores for UI state
  - [ ] Setup development tools (React Query DevTools)

- [ ] Task 5: Configure API Client Integration (AC: 4)
  - [ ] Create API client service with type-safe methods
  - [ ] Configure environment variables for API base URL
  - [ ] Setup error handling and response standardization
  - [ ] Create React Query hooks for API endpoints
  - [ ] Implement authentication token management

- [ ] Task 6: Setup Dependency Management Strategy (AC: 3, 5)
  - [ ] Create package.json with exact versions for critical dependencies
  - [ ] Configure npm audit and vulnerability scanning
  - [ ] Setup peer dependency validation checks
  - [ ] Create installation validation script (check npm list, peer deps, TS compile)
  - [ ] Document dependency installation order and troubleshooting

- [ ] Task 7: Configure Testing Framework (AC: 5)
  - [ ] Install Vitest with React Testing Library
  - [ ] Configure test setup with Next.js compatibility
  - [ ] Create test utilities and mock providers
  - [ ] Setup MSW (Mock Service Worker) for API mocking with handlers for /health and /clients
  - [ ] Implement sample component tests

- [ ] Task 8: Implement Basic UI Components (AC: 2)
  - [ ] Install core shadcn/ui components (Button, Card, Input, Select, Label, Form)
  - [ ] Create layout components (Header, Sidebar, Footer)
  - [ ] Implement basic dashboard page structure
  - [ ] Create placeholder components for project list
  - [ ] Setup navigation and routing

- [ ] Task 9: Validate Frontend-Backend Integration (AC: 4)
  - [ ] PREREQUISITE: Verify Story 1.3 backend is running (uvicorn core.main:app at localhost:8001)
  - [ ] Configure CORS settings in Next.js for API communication
  - [ ] Test API client connectivity to backend health endpoint (GET /api/v1/health)
  - [ ] Verify environment variable loading
  - [ ] Test error handling for API failures
  - [ ] Validate type safety end-to-end (API to UI)

- [ ] Task 10: Complete Installation Validation (AC: 1, 2, 3, 4, 5)
  - [ ] Verify all dependencies install without conflicts
  - [ ] Test Next.js application builds successfully (npm run build)
  - [ ] Validate development server hot reload (npm run dev, edit src/app/page.tsx)
  - [ ] Run test suite to ensure all tests pass (npm run test)
  - [ ] Document setup procedures and common issues
